...
public class NadMusic extends RelativeLayout implements NotificationMediaManager.MediaListener, Palette.PaletteAsyncListener {
   private static final boolean DEBUG = true;
   private static final String TAG = "NadMusic";
   ...
   private NadMusic mBackground;

   public NadMusic(Context context) {
       this(context, null);
   }

   public NadMusic(Context context, AttributeSet attrs) {
       this(context, attrs, 0);
   }

   public NadMusic(Context context, AttributeSet attrs, int defStyleAttr) {
       this(context, attrs, defStyleAttr, 0);
   }

   public NadMusic(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
